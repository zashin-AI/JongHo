...
path = 'C:/nmb/nmb_data/h5/5s/RNN/GRU/GRU_adam_1.h5'
mc = ModelCheckpoint(path, monitor='val_loss', verbose=1, save_best_only=True)
history = model.fit(x_train, y_train, epochs=300, batch_size=16, validation_split=0.2, callbacks=[es, lr, mc])

# 평가, 예측
# model = load_model('C:/nmb/nmb_data/h5/5s/RNN/GRU/GRU_adam_1.h5')
model.load_weights('C:/nmb/nmb_data/h5/5s/RNN/GRU/GRU_adam_1.h5')

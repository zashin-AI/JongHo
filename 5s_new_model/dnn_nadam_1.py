...
path = 'C:/nmb/nmb_data/h5/5s/DNN_nadam_1.h5'
...
# 평가, 예측
model.load_weights('C:/nmb/nmb_data/h5/5s/DNN_nadam_1.h5')

# 평가, 예측
# model = load_model('C:/nmb/nmb_data/h5/5s/DNN_nadam_1.h5')
model.load_weights('C:/nmb/nmb_data/h5/5s/DNN_nadam_1.h5')

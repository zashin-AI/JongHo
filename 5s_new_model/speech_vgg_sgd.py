...
# 평가, 예측
# model = load_model('C:/nmb/nmb_data/h5/5s/speech_vgg/speechvgg_sgd_1.h5')
model.load_weights('C:/nmb/nmb_data/h5/5s/speech_vgg/speechvgg_sgd_1.h5')

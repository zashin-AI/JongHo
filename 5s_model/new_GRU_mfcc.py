...
# loss :  0.30696749687194824
# acc :  0.881118893623352
# C:\nmb\nmb_data\pred_voice\FY1.wav 61.83057427406311 %의 확률로 남자입니다.
# C:\nmb\nmb_data\pred_voice\MZ1.wav 76.83530449867249 %의 확률로 남자입니다.
# C:\nmb\nmb_data\pred_voice\friendvoice_F4.wav 57.36496448516846 %의 확률로 남자입니다.
# C:\nmb\nmb_data\pred_voice\friendvoice_M3.wav 74.65369701385498 %의 확률로 남자입니다.
# C:\nmb\nmb_data\pred_voice\friendvoice_M4.wav 86.6753101348877 %의 확률로 남자입니다.
# C:\nmb\nmb_data\pred_voice\friendvoice_M5.wav 55.86975812911987 %의 확률로 남자입니다.
# C:\nmb\nmb_data\pred_voice\friendvoice_M6.wav 76.67911648750305 %의 확률로 남자입니다.
# C:\nmb\nmb_data\pred_voice\friendvoice_M7.wav 76.65075659751892 %의 확률로 남자입니다.
# C:\nmb\nmb_data\pred_voice\testvoice_F1(clear).wav 92.49202609062195 %의 확률로 남자입니다.
# C:\nmb\nmb_data\pred_voice\testvoice_F1_high(clear).wav 79.72394227981567 %의 확률로 남자입니다.
# C:\nmb\nmb_data\pred_voice\testvoice_F2(clear).wav 83.1910252571106 %의 확률로 여자입니다.
# C:\nmb\nmb_data\pred_voice\testvoice_F3(clear).wav 75.87357759475708 %의 확률로 남자입니다.
# C:\nmb\nmb_data\pred_voice\testvoice_M1(clear).wav 79.01976704597473 %의 확률로 남자입니다.
# C:\nmb\nmb_data\pred_voice\testvoice_M2(clear).wav 84.81664657592773 %의 확률로 남자입니다.
# C:\nmb\nmb_data\pred_voice\testvoice_M2_low(clear).wav 85.66786646842957 %의 확률로 남자입니다.
# time >>  0:04:08.345860
# 정답률 : 9/15

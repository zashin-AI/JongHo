...
# loss :  0.7031797170639038
# acc :  0.45221444964408875
# C:\nmb\nmb_data\pred_voice\FY1.wav 53.7589967250824 %의 확률로 남자입니다.
# C:\nmb\nmb_data\pred_voice\MZ1.wav 53.75902056694031 %의 확률로 남자입니다.
# C:\nmb\nmb_data\pred_voice\friendvoice_F4.wav 53.759247064590454 %의 확률로 남자입니다.
# C:\nmb\nmb_data\pred_voice\friendvoice_M3.wav 53.75896692276001 %의 확률로 남자입니다.
# C:\nmb\nmb_data\pred_voice\friendvoice_M4.wav 53.75915169715881 %의 확률로 남자입니다.
# C:\nmb\nmb_data\pred_voice\friendvoice_M5.wav 53.75908017158508 %의 확률로 남자입니다.
# C:\nmb\nmb_data\pred_voice\friendvoice_M6.wav 53.759175539016724 %의 확률로 남자입니다.
# C:\nmb\nmb_data\pred_voice\friendvoice_M7.wav 53.75921130180359 %의 확률로 남자입니다.
# C:\nmb\nmb_data\pred_voice\testvoice_F1(clear).wav 53.759169578552246 %의 확률로 남자입니다.
# C:\nmb\nmb_data\pred_voice\testvoice_F1_high(clear).wav 53.758907318115234 %의 확률로 남자입니다.
# C:\nmb\nmb_data\pred_voice\testvoice_F2(clear).wav 53.75910401344299 %의 확률로 남자입니다.
# C:\nmb\nmb_data\pred_voice\testvoice_F3(clear).wav 53.75898480415344 %의 확률로 남자입니다.
# C:\nmb\nmb_data\pred_voice\testvoice_M1(clear).wav 53.7591278553009 %의 확률로 남자입니다.
# C:\nmb\nmb_data\pred_voice\testvoice_M2(clear).wav 53.758955001831055 %의 확률로 남자입니다.
# C:\nmb\nmb_data\pred_voice\testvoice_M2_low(clear).wav 53.75915169715881 %의 확률로 남자입니다.
# time >>  0:19:08.143155
# 정답률 : 9/15

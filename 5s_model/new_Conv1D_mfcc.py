...
print(x_train.shape, y_train.shape) # (1712, 20, 862) (1712,)
print(x_test.shape, y_test.shape)   # (429, 20, 862) (429,)
...
# Total params: 1,573,010
# Trainable params: 1,573,010

...
from tensorflow.keras.layers import Dense, Conv2D, MaxPool1D, AveragePooling1D, Dropout, Activation, Flatten, Add, Input, Concatenate, LeakyReLU, ReLU, Dense, LSTM, SimpleRNN
...
def residual_block(x, units, conv_num=3, activation='tanh'):  # ( input, output node, for 문 반복 횟수, activation )
    ...
    for i in range(conv_num - 1):
        x = Dense(units)(x) # return_sequences=True 이거 사용해서 lstm shape 부분 3차원으로 맞춰줌 -> 자세한 내용 찾아봐야함
...
model.save('C:/nmb/nmb_data/h5/5s/0601/DNN_lstm_1.h5')
...
path = 'C:/nmb/nmb_data/h5/5s/0601/DNN_lstm_1.h5'
...
# 평가, 예측
# model = load_model('C:/nmb/nmb_data/h5/5s/0601/DNN_lstm_1.h5')
model.load_weights('C:/nmb/nmb_data/h5/5s/0601/DNN_lstm_1.h5')

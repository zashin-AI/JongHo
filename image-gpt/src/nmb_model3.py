...
print("y_one_hot=========>", y_one_hot.shape)   # (4536, 2)

x_train, x_test, y_train, y_test = train_test_split(x, y_one_hot, train_size=0.8, shuffle=True, random_state=42)

print(x_train.shape, y_train.shape) # (3628, 128, 862) (3628, 2)
print(x_test.shape, y_test.shape)   # (908, 128, 862) (908, 2) -> (908, 128, 862) (908,)

...
print(x1.shape, y1.shape) # (466, 128, 862) (466,)
...
print(x2.shape, y2.shape) # (1764, 128, 862) (1764,)

x = np.concatenate([x1, x2], 0)
y = np.concatenate([y1, y2], 0)

np.save('C:/nmb/nmb_data/npy/project_total_npy/total_f20_m80_data.npy', arr=x)
np.save('C:/nmb/nmb_data/npy/project_total_npy/total_f20_m80_label.npy', arr=y)

...
print(x_train.shape, y_train.shape) # (1844, 128, 862, 1) (1844,)
print(x_test.shape, y_test.shape)   # (461, 128, 862, 1) (461,)
...
model.save('C:/nmb/nmb_data/h5/5s/Transfer/mobilenet/mobilenet_rmsprop_f80_m20.h5')
...
path = 'C:/nmb/nmb_data/h5/5s/Transfer/mobilenet/mobilenet_rmsprop_f80_m20.h5'
...
# 평가, 예측
model = load_model('C:/nmb/nmb_data/h5/5s/Transfer/mobilenet/mobilenet_rmsprop_f80_m20.h5')
# model.load_weights('C:/nmb/nmb_data/h5/5s/Transfer/mobilenet/mobilenet_rmsprop_f80_m20.h5')

...
# 평가, 예측
# model = load_model('C:/nmb/nmb_data/h5/5s/mobilenet/mobilenet_rmsprop_f80_m20_2.h5')
model.load_weights('C:/nmb/nmb_data/h5/5s/mobilenet/mobilenet_rmsprop_f80_m20_2.h5')

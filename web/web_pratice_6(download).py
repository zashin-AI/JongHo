...
def download():
    ...
    if request.method == 'POST':
        ...
        for i, chunk in enumerate(audio_chunks):
            ...
            try:
                f = open('C:/nmb/nada/Jongho/JongHo/web/static/test.txt', 'wt', encoding='utf-8')
                ff = open('C:/nmb/nada/Jongho/JongHo/web/static/test_female.txt', 'wt', encoding='utf-8')
                fm = open('C:/nmb/nada/Jongho/JongHo/web/static/test_male.txt', 'wt', encoding='utf-8')
...
def download_all():
    filename = 'C:/nmb/nada/Jongho/JongHo/web/static/test.txt'
    return send_file(
        filename,
        as_attachment=True,
        mimetype='text/txt',
...
def download_female():
    filename = 'C:/nmb/nada/Jongho/JongHo/web/static/test_female.txt'
    return send_file(
        filename,
        as_attachment=True,
        mimetype='text/txt',
...
def download_male():
    filename = 'C:/nmb/nada/Jongho/JongHo/web/static/test_male.txt'
    return send_file(
        filename,
        as_attachment=True,
        mimetype='text/txt',
...
@app.route('/readAll')
def read_all():
    f = open('C:/nmb/nada/Jongho/JongHo/web/static/test.txt', 'r', encoding='utf-8')
    return "</br>".join(f.readlines())

@app.route('/readFemale')
def read_female():
    f = open('C:/nmb/nada/Jongho/JongHo/web/static/test_female.txt', 'r', encoding='utf-8')
    return "</br>".join(f.readlines())

@app.route('/readMale')
def read_male():
    f = open('C:/nmb/nada/Jongho/JongHo/web/static/test_male.txt', 'r', encoding='utf-8')
    return "</br>".join(f.readlines())

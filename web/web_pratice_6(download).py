...
def download():
    ...
    if request.method == 'POST':
        ...
        for i, chunk in enumerate(audio_chunks):
            ...
            try:
                f = open('C:/nmb/nada/static/test.txt', 'wt', encoding='utf-8')
                ff = open('C:/nmb/nada/static/test_female.txt', 'wt', encoding='utf-8')
                fff = open('C:/nmb/nada/static/test_male.txt', 'wt', encoding='utf-8')

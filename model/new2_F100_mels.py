...
dataset = []
label = []
pathAudio_F = 'C:/nmb/nmb_data/F100/F/' 
pathAudio_M = 'C:/nmb/nmb_data/F100/M/'
...
# np.save('C:/nmb/nmb_data/npy/F_F100_mels.npy', arr=dataset)
# np.save('C:/nmb/nmb_data/npy/F_F100_label_mels.npy', arr=label)
np.save('C:/nmb/nmb_data/npy/M_F100_mels.npy', arr=dataset)
np.save('C:/nmb/nmb_data/npy/M_F100_label_mels.npy', arr=label)

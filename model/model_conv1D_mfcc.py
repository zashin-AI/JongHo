...
# C:\nmb\nmb_data\pred_voice\MZ1.wav 100.0 %의 확률로 여자입니다.
# C:\nmb\nmb_data\pred_voice\friendvoice_F4.wav 100.0 %의 확률로 여자입니다.
# C:\nmb\nmb_data\pred_voice\friendvoice_M3.wav 100.0 %의 확률로 여자입니다.
# C:\nmb\nmb_data\pred_voice\friendvoice_M4.wav 100.0 %의 확률로 여자입니다.
# C:\nmb\nmb_data\pred_voice\friendvoice_M5.wav 100.0 %의 확률로 여자입니다.
# C:\nmb\nmb_data\pred_voice\friendvoice_M6.wav 100.0 %의 확률로 여자입니다.
# C:\nmb\nmb_data\pred_voice\friendvoice_M7.wav 100.0 %의 확률로 여자입니다.
# C:\nmb\nmb_data\pred_voice\testvoice_F1(clear).wav 100.0 %의 확률로 여자입니다.
# C:\nmb\nmb_data\pred_voice\testvoice_F1_high(clear).wav 100.0 %의 확률로 여자입니다.
# C:\nmb\nmb_data\pred_voice\testvoice_F2(clear).wav 100.0 %의 확률로 여자입니다.
# C:\nmb\nmb_data\pred_voice\testvoice_F3(clear).wav 100.0 %의 확률로 여자입니다.
# C:\nmb\nmb_data\pred_voice\testvoice_M1(clear).wav 100.0 %의 확률로 여자입니다.
# C:\nmb\nmb_data\pred_voice\testvoice_M2(clear).wav 100.0 %의 확률로 여자입니다.
# C:\nmb\nmb_data\pred_voice\testvoice_M2_low(clear).wav 100.0 %의 확률로 여자입니다.
# time >>  0:00:33.975135
...
dataset = []
label = []
pathAudio_F = 'C:/nmb/nmb_data/M100/F/' 
pathAudio_M = 'C:/nmb/nmb_data/M100/M/'
...
# np.save('C:/nmb/nmb_data/npy/F_M100_mels.npy', arr=dataset)
# np.save('C:/nmb/nmb_data/npy/F_M100_label_mels.npy', arr=label)
np.save('C:/nmb/nmb_data/npy/M_M100_mels.npy', arr=dataset)
np.save('C:/nmb/nmb_data/npy/M_M100_label_mels.npy', arr=label)
